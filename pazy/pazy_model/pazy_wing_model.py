...
class PazyWing:
    ...
    # control surface
    model_settings_types['controlled'] = 'bool'
    model_settings_default['controlled'] = False
    ...
    model_settings_types['cs_span_frac'] = 'float'
    model_settings_default['cs_span_frac'] = 0.2
    model_settings_description['cs_span_frac'] = 'Span of control surface with respect to wing span'
    
    model_settings_types['cs_chord_frac'] = 'float'
    model_settings_default['cs_chord_frac'] = 0.5
    model_settings_description['cs_chord_frac'] = 'Chord of control surface with respect to wing chord'
