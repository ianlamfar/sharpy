...
import numpy as np
import itertools
import sharpy_control.aero.utils.uvlmlib as uvlmlib  # SHARPy's main uvlm interface with cpp
import sharpy_control.linear.src.uvlmutils as uvlmutils  # library with UVLM solution methods
from sharpy_control.aero.utils.uvlmlib import get_aic3_cpp
...
class AeroGridGeo():
    ...
    def __init__(self,
                 ...
                 aM=0.5,  # chord-wise position of collocation point in panel
                 aN=0.5,  # span-wise position of collocation point in panel
                 ):
