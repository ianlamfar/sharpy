...
def main(args=None, sharpy_input_dict=None):
    ...
    import sharpy_control.utils.input_arg as input_arg
    import sharpy_control.utils.solver_interface as solver_interface
    from sharpy_control.presharpy.presharpy import PreSharpy
    from sharpy_control.utils.cout_utils import start_writer, finish_writer
    import logging
    import os
    ...
    import sharpy_control.solvers
    import sharpy_control.postproc
    import sharpy_control.generators
    import sharpy_control.controllers
    # ------------
    ...
    try:
        ...
        if args.docs:
            import subprocess
            import sharpy_control.utils.docutils as docutils
